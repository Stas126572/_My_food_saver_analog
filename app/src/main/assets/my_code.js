...
var createMyWasmModule = (() => {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(createMyWasmModule) {
  createMyWasmModule = createMyWasmModule || {};
...
var Module = typeof createMyWasmModule != 'undefined' ? createMyWasmModule : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_count')) {
        Object.defineProperty(Module['ready'], '_get_count', { configurable: true, get: function() { abort('You are getting _get_count on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_count', { configurable: true, set: function() { abort('You are setting _get_count on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
run();
  ...
  return createMyWasmModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = createMyWasmModule;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return createMyWasmModule; });
else if (typeof exports === 'object')
  exports["createMyWasmModule"] = createMyWasmModule;
